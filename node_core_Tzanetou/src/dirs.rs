...
//!
//! This module provides utilities for managing reth data directories.
//! It includes functions and types to construct and resolve paths for various directories 
//! such as data, configuration, cache, and logs. These paths follow the XDG Base Directory 
//! Specification for cross-platform compatibility and allow for user-defined overrides.
