...
//!
//! This module provides utility functions and parsers for various CLI parsing tasks,
//! including parsing chain specifications, durations from seconds, socket addresses,
//! and hash or number values for blocks.
//!
//! Depending on the feature flags (`optimism`), different chains are supported
