//! Ethereum 2.0 types module.
//!
//! This module provides types and utilities specific to Ethereum 2.0, including attestations,
//! blocks, validators, deposits, and more.

// Clippy lint set up to deny certain warnings by default, except in test mode
#![cfg_attr(
    not(test),
    deny(
...
#[macro_use]
pub mod test_utils; // Module for test utilities

// Individual modules for Ethereum 2.0 types
...
#[macro_use]
pub mod slot_epoch_macros; // Macros related to slot and epoch calculations
...
// Cache and storage related modules
pub mod epoch_cache;
pub mod slot_data;
#[cfg(feature = "sqlite")]
pub mod sqlite;
...
pub mod blob_sidecar; // Blob storage sidecar utilities
pub mod light_client_header; // Light client header types
pub mod non_zero_usize; // Non-zero usize wrapper
pub mod runtime_var_list; // Runtime variable list utilities

use ethereum_types::{H160, H256}; // Ethereum specific types
...
// Type aliases for commonly used types in Ethereum 2.0 context
...
// Re-export commonly used cryptographic primitives
pub use bls::{
    AggregatePublicKey, AggregateSignature, Keypair, PublicKey, PublicKeyBytes, SecretKey,
    Signature, SignatureBytes,
};
pub use kzg::{KzgCommitment, KzgProof, VERSIONED_HASH_VERSION_KZG};
pub use milhouse::{self, List, Vector}; // Utility types for list and vector operations
pub use ssz_types::{typenum, typenum::Unsigned, BitList, BitVector, FixedVector, VariableList}; // SSZ serialization types
pub use superstruct::superstruct; // Struct-based serialization

// Module documentation
//! This module provides Ethereum 2.0 types and utilities for blockchain and consensus layer.
