...
/// # Arguments
///
/// * `state` - The current state of the beacon chain.
/// * `data` - The attestation data to get participation flags for.
/// * `inclusion_delay` - The delay in slots between the attestation and its inclusion slot.
/// * `spec` - The chain specification defining constants and rules.
///
/// # Returns
///
/// Returns a `SmallVec` containing indices of participation flags.
///
/// # Errors
///
/// Returns an `Error` if the attestation source does not match the justified checkpoint.
