...
impl TransportSenderT for Sender {
    ...
    /// Sends a ping message. Currently not implemented.
    ///
    /// # Returns
    ///
...
impl TransportReceiverT for Receiver {
    ...
    /// Returns a Future resolving when the server sends something back.
    ///
    /// # Returns
    ///
...
impl IpcTransportClientBuilder {
    /// Builds a new IPC transport client.
    ///
    /// # Arguments
    ///
    ...
    /// # Returns
    ///
    /// A result containing the `Sender` and `Receiver` pair or an error.
...
impl IpcClientBuilder {
    ...
    /// # Arguments
    ///
    /// * `name` - The file system path to the Unix socket.
    ///
    /// # Returns
    ///
    ...
    /// # Arguments
    ///
    /// * `sender` - The sending end of the transport.
    /// * `receiver` - The receiving end of the transport.
    ///
    /// # Returns
    ///
...
mod tests {
    ...
    /// Tests the IPC client connection.
    #[tokio::test]
