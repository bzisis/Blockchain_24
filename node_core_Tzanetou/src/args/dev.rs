...
mod tests {
    ...
    /// Test to check if the default dev arguments are parsed correctly.
    #[test]
    ...
    /// Test to check if conflicting arguments result in an error.
    #[test]
    ...
    /// Test to check if the default dev arguments are sane.
    #[test]
