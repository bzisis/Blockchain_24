...
/// Compute the reward or penalty delta for a specific attestation component.
...
/// Compute the reward delta for the source component of an attestation.
fn get_source_delta(
...
/// Compute the reward delta for the target component of an attestation.
fn get_target_delta(
    validator: &ValidatorStatus,
    base_reward: u64,
    total_balances: &TotalBalances,
...
/// Compute the reward delta for the head component of an attestation.
fn get_head_delta(
    validator: &ValidatorStatus,
    base_reward: u64,
    total_balances: &TotalBalances,
...
/// Compute the reward and proposer reward delta for the inclusion delay component of an attestation.
...
/// Compute the inactivity penalty delta for a validator.
