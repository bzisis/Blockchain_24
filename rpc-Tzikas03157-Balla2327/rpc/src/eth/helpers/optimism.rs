    ...
    Provider: BlockIdReader + ChainSpecProvider,
{
    ...
    /// # Returns
    ///
    /// An `EthResult` wrapping the transaction receipt.
    ...
    EvmConfig: ConfigureEvm,
{
    ...
    /// Assembles a receipt for a transaction.
    ///
    /// # Arguments
    ///
    /// * `tx` - The signed and recovered transaction.
    /// * `result` - The execution result.
    /// * `cumulative_gas_used` - The cumulative gas used.
    ///
    /// # Returns
    ///
    /// The assembled transaction receipt.
    fn assemble_receipt(
        &self,
    ...
    /// Calculates the receipts root for a block.
    ///
    /// # Arguments
    ///
    /// * `_block_env` - The block environment.
    /// * `execution_outcome` - The execution outcome.
