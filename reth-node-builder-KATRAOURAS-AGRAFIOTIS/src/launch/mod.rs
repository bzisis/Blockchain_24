...
///
/// Acts as a node factory and encapsulates the launch logic for a node.
///
...
impl DefaultNodeLauncher {
    ...
    /// # Returns
    ///
    /// A new `DefaultNodeLauncher` instance.
    ...
    CB: NodeComponentsBuilder<T>,
{
    ...
    /// # Arguments
    ///
    /// - `target`: The node builder with components.
    ///
    /// # Returns
    ///
    /// A future that resolves to the created node.
