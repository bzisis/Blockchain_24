...
///
/// We distinguish between different kinds of components:
    ...
    ComponentsBuilder<Node, PoolB, PayloadB, NetworkB, ExecB>
{
    ...
    /// # Arguments
    ///
    /// - `Types`: The node types to configure.
    ///
    /// # Returns
    ///
    /// A new `ComponentsBuilder` instance with the specified node types.
    ...
    /// # Arguments
    ///
    /// - `f`: The function to apply to the pool builder.
    ///
    /// # Returns
    ///
    /// A new `ComponentsBuilder` instance with the modified pool builder.
    ...
    /// # Arguments
    ///
    /// - `f`: The function to apply to the payload builder.
    ///
    /// # Returns
    ///
    /// A new `ComponentsBuilder` instance with the modified payload builder.
    ...
    /// # Arguments
    ///
    /// - `f`: The function to apply to the network builder.
    ///
    /// # Returns
    ///
    /// A new `ComponentsBuilder` instance with the modified network builder.
    ...
    /// # Arguments
    ///
    /// - `f`: The function to apply to the executor builder.
    ///
    /// # Returns
    ///
    /// A new `ComponentsBuilder` instance with the modified executor builder.
    ...
    Node: FullNodeTypes,
{
    ...
    /// # Arguments
    ///
    /// - `pool_builder`: The pool builder to configure.
    ///
    /// # Returns
    ///
    /// A new `ComponentsBuilder` instance with the specified pool builder.
    pub fn pool<PB>(
        self,
        pool_builder: PB,
    ...
    PoolB: PoolBuilder<Node>,
{
    ...
    /// # Arguments
    ///
    /// - `network_builder`: The network builder to configure.
    ///
    /// # Returns
    ///
    /// A new `ComponentsBuilder` instance with the specified network builder.
    pub fn network<NB>(
        self,
        network_builder: NB,
    ...
    /// # Arguments
    ///
    /// - `payload_builder`: The payload builder to configure.
    ///
    /// # Returns
    ///
    /// A new `ComponentsBuilder` instance with the specified payload builder.
    pub fn payload<PB>(
        self,
        payload_builder: PB,
    ...
    ///
    /// This accepts an [`ExecutorBuilder`] instance that will be used to create the node's components
    /// for execution.
    ///
    /// # Arguments
    ///
    /// - `executor_builder`: The executor builder to configure.
    ///
    /// # Returns
    ///
    /// A new `ComponentsBuilder` instance with the specified executor builder.
    pub fn executor<EB>(
        self,
        executor_builder: EB,
    ...
    ExecB: ExecutorBuilder<Node>,
{
    ...
    /// # Returns
    ///
    /// A future that resolves to the created components.
