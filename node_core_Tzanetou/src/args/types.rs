...
//!
//! This module provides helper types and macros to facilitate parsing CLI arguments
//! into specific types, handling special cases like mapping "0" to `None` and parsing
//! "max" as the maximum value of a specified type.
