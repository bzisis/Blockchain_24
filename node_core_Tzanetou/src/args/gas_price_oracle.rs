//! This module defines the command-line arguments for configuring the Gas Price Oracle in the Reth Ethereum project.
//! It uses the `clap` crate to parse and validate the arguments.
//! The module also includes functions to convert these arguments into a `GasPriceOracleConfig` and unit tests to verify the correct parsing of arguments.
...
impl GasPriceOracleArgs {
    ...
    /// This function creates a configuration object for the Gas Price Oracle using the parsed arguments.
...
impl Default for GasPriceOracleArgs {
    /// This function returns a `GasPriceOracleArgs` instance with default values.
    fn default() -> Self {
        Self {
