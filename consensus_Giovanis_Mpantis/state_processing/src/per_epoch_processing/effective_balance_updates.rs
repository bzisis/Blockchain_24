...
///
/// Updates the effective balances of validators in the given `BeaconState`.
///
/// # Arguments
///
...
/// # Returns
///
/// Returns `Ok(())` if the balances are successfully updated, otherwise returns an `EpochProcessingError`.
///
/// # Errors
///
/// Returns `EpochProcessingError` if any arithmetic operation or state manipulation fails.
...
///
/// This function is a slower version of `process_effective_balance_updates` intended for testing purposes.
///
/// # Arguments
///
/// * `state` - A mutable reference to the `BeaconState`.
...
/// # Returns
///
/// Returns `Ok(())` if the balances are successfully updated using the single-pass process, otherwise returns an `EpochProcessingError`.
///
/// # Errors
///
/// Returns `EpochProcessingError` if the single-pass processing fails.
