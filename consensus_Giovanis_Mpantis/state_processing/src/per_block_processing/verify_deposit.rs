...
/// Returns an error for a given `DepositInvalid` reason.
...
/// # Arguments
///
/// * `deposit_data` - The deposit data to verify.
...
/// * `pub_key` - The public key bytes to search for.
///
/// # Returns
///
/// `Result` containing either `Some(u64)` representing the validator index, or `None`.
...
///
/// * `state` - The beacon state.
/// * `deposit` - The deposit to verify.
/// * `deposit_index` - The index of the deposit.
/// * `spec` - The chain specification.
///
/// # Returns
///
