...
pub struct AppendableChain {
    /// The chain of blocks with state.
    chain: Chain,
}

// Implementing Deref for AppendableChain to treat it like a Chain
...
// Implementing DerefMut for AppendableChain to allow mutable operations like a Chain
...
impl AppendableChain {
        ...
        E: BlockExecutorProvider,
    {
        ...
        // Create a new chain with the executed block
        ...
        E: BlockExecutorProvider,
    {
        ...
        // Extend the state with the block state
        ...
        E: BlockExecutorProvider,
    {
        ...
        // Extend the state and append the block to the chain.
