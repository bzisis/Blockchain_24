...
/// Define the Ethereum hardforks using the hardfork! macro.
hardfork!(
...
impl EthereumHardfork {
    ...
    pub const fn mainnet_activation_block(&self) -> Option<u64> {
        /// Return activation block based on hardfork variant for mainnet.
        match self {
    ...
    pub const fn sepolia_activation_block(&self) -> Option<u64> {
        /// Return activation block based on hardfork variant for sepolia testnet.
        match self {
            Self::Paris => Some(1735371),
            Self::Shanghai => Some(2990908),
            Self::Cancun => Some(5187023),
            /// For other hardforks, return None as they are not activated on sepolia.
            Self::Frontier |
            Self::Homestead |
            Self::Dao |
            Self::Tangerine |
    ...
    const fn holesky_activation_block(&self) -> Option<u64> {
        /// Return activation block based on hardfork variant for holesky testnet.
        match self {
            Self::Dao |
            Self::Tangerine |
            Self::SpuriousDragon |
    ...
    pub const fn arbitrum_sepolia_activation_block(&self) -> Option<u64> {
        /// Return activation block based on hardfork variant for Arbitrum Sepolia testnet.
        match self {
            Self::Frontier |
            Self::Homestead |
            Self::Dao |
    ...
    pub const fn arbitrum_activation_block(&self) -> Option<u64> {
        /// Return activation block based on hardfork variant for Arbitrum One mainnet.
        match self {
            Self::Frontier |
            Self::Homestead |
            Self::Dao |
    ...
    pub fn activation_timestamp(&self, chain: Chain) -> Option<u64> {
        /// Match chain type to return activation timestamp for mainnet, sepolia, or holesky.
        if chain == Chain::mainnet() {
    ...
    pub const fn mainnet_activation_timestamp(&self) -> Option<u64> {
        /// Return activation timestamp based on hardfork variant for mainnet.
        match self {
            ...
            /// Add upcoming hardforks with None until they activate.
            _ => None,
        }
    }
    ...
    pub const fn sepolia_activation_timestamp(&self) -> Option<u64> {
        /// Return activation timestamp based on hardfork variant for sepolia testnet.
        match self {
            Self::Frontier |
            Self::Homestead |
            Self::Dao |
    ...
    pub const fn holesky_activation_timestamp(&self) -> Option<u64> {
        /// Return activation timestamp based on hardfork variant for holesky testnet.
        match self {
    ...
    pub const fn arbitrum_sepolia_activation_timestamp(&self) -> Option<u64> {
        /// Return activation timestamp based on hardfork variant for Arbitrum Sepolia testnet.
        match self {
            Self::Frontier |
            Self::Homestead |
            Self::Dao |
    ...
    pub const fn arbitrum_activation_timestamp(&self) -> Option<u64> {
        /// Return activation timestamp based on hardfork variant for Arbitrum One mainnet.
        match self {
            Self::Frontier |
            Self::Homestead |
            Self::Dao |
